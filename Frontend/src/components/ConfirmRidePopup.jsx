...
const submitHandler = (e) => {
  ...
  return (
   <div>
      ...
      <div className='flex mt-4 p-3 border-2 border-[#8ff8ea] rounded-lg items-center justify-between'>
       ...
       <div className='mt-6 w-full  '>
           <form onSubmit={(e)=>{
            ...
            <input value={otp} onChange={(e)=>setOtp(e.target.value)} type="text"className=' bg-[#eeeeee] mt-3  rounded px-6 py-4 w-full text-lg font-mono ' placeholder='Enter OTP'  />
                ...
                <Link to='/captain-riding' className='w-full mt-5 flex justify-center bg-[#04665a] text-white font-semibold text-lg p-3 rounded-lg '>
          Confirm Ride
        </Link>
         <button 
        onClick={() => {
