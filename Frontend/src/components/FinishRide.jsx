...
const FinishRide = (props) => {
  return (
   <div>
      ...
      <div className='flex mt-4 p-4 border-2 border-yellow-400 rounded-lg items-center justify-between'>
      ...
      <div className='flex flex-col gap-2 justufy-between items-center '>
       ...
       <div className='mt-6 w-full  '>
                ...
                className='w-full mt-3 flex justify-center bg-green-600 text-white font-semibold text-lg p-3 rounded-lg '>Finish
        </Link>
