...
const RidePopup = (props) => {
  return (
    <div>
      ...
      <div className='flex mt-4 p-3 bg-[#78ece0] rounded-lg items-center justify-between'>
      ...
      <div className='flex w-full items-center justify-between mt-3 '>
       ...
       Ignore
        ...
        onClick={() => {
         ...
         className=' bg-[#04665a] text-white font-semibold text-lg p-2 px-13 rounded-lg '>
         Accept
        </button>
